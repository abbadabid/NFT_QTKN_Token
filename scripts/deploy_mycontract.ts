...
async function main() {
    ...
    const nft = await Nft.attach("0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9");
    ...
    const txt9 = await mycontract.showNftId("OOP");
    console.log("NFT of OOP is on id", txt9)

    const txt10 = await mycontract.showNftId("Data Structres");
    console.log("NFT of DS is on id", txt10)

    console.log("Owner of the course OOP is:", await mycontract.showOwner("OOP"));
    console.log("Owner of the course OOP through nft contract is:", await nft.ownerOf(txt9.toNumber()));

    console.log("Owner of the course Data Structures is:", await mycontract.showOwner("Data Structres"));
    console.log("Owner of the course Data Structures through nft contract is:", await nft.ownerOf(txt10.toNumber()));
